...
import com.nsw2022.todocatcheck.databinding.ActivityIntroBinding;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadData();// 저장된 프로필 정보와 이름을 가져와서 보여주는 기능 호출

    }//onCreate

    //// SharedPreferences 에tj 프로필이미지와 이름을 가져와 화면에 보여주기
    void loadData(){
    ...
    // SharedPreferences 에 프로필이미지와 이름을 영구히 저장
   void saveData(){
